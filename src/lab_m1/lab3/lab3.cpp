...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    translateX += direction * deltaTimeSeconds * 100;
    ...
    scaleX += direction_scale * deltaTimeSeconds;
    scaleY += direction_scale * deltaTimeSeconds;
    ...
    // transform matrix with the matrices you just implemented
    // Remember, the last matrix in the chain will take effect first!
    angularStep -= direction * deltaTimeSeconds * 10;
    ...
    modelMatrix *= transform2D::Translate(translateX, translateY);
    RenderMesh2D(meshes["rect2"], shaders["VertexColor"], modelMatrix);

    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(520, 470);
    modelMatrix *= transform2D::Translate(translateX, translateY);
    ...
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(650, 470);
    modelMatrix *= transform2D::Translate(translateX, translateY);
    modelMatrix *= transform2D::Translate(15, 15);
    modelMatrix *= transform2D::Rotate(angularStep);
    modelMatrix *= transform2D::Translate(-15, -15);
