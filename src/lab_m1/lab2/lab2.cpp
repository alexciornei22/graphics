...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 255 , 255)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(255, 0 ,255)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(255, 255 ,0)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 255 ,0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 255 ,255)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(255, 255 ,255)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(128, 128 ,128)),
        };
        ...
        vector<VertexFormat> tetr_vertices =
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 255 , 255)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0 , 255)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 255 , 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(255, 0 , 0)),
        };

        vector<unsigned int> tetr_indices =
        {
            0, 2, 1,
            1, 2, 3,
            0, 3, 2,
        ...
        CreateMesh("tetr", tetr_vertices, tetr_indices);
    ...
    {
        vector<VertexFormat> sq_vertices =
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 255 , 255)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0 , 255)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 255 , 0)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(255, 0 , 0)),
        };

        vector<unsigned int> sq_indices =
        {
            0, 1, 2,
            3, 1, 2,
        };

        CreateMesh("square", sq_vertices, sq_indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexNormal"], glm::vec3(1, 1, 1), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetr"], shaders["VertexNormal"], glm::vec3(2, 2, 2), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexNormal"], glm::vec3(-1, 0, -1), glm::vec3(0.5f));
