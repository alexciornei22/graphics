...
void WorldOfTanks::RenderProjectile(tank::Projectile& projectile)
{
    ...
    RenderColorMesh(meshes["shell1"], shaders["Color"], modelMatrix, glm::vec3(0.2f));
}
...
void WorldOfTanks::RenderBuilding(Building& building)
{
    ...
    RenderColorMesh(meshes["box"], shaders["Color"], modelMatrix, glm::vec3(0.8f));
}

void WorldOfTanks::RenderPlane()
{
    glm::mat4 modelMatrix = glm::scale(glm::mat4(1.f), glm::vec3(4.f, 0, 4.f));
    RenderColorMesh(meshes["plane50"], shaders["Color"], modelMatrix, glm::vec3(0, 0.5, 0));
}
...
void WorldOfTanks::RenderColorMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    if (!mesh || !shader || !shader->program)
        return;
