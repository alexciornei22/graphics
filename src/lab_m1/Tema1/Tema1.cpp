...
void Tema1::Init()
{
    ...
    for (int i = 0; i < NR_SHOOTERS; i++) {
        itemCoordinates.push_back(
            gui::ItemBoxData(SEPARATION + i * (SEPARATION + SQUARE_LENGTH), logicSpace.height - SQUARE_LENGTH - SEPARATION, SQUARE_LENGTH, i)
        );
    }
